...
- github pipeline building broken binaries
...
- Fixed migrated bucket bytesDone not incremented ()
...
- (users) Windows CLI arm builds removed as not supported by `windows-curses`

## [2026.8.3] - 2026-08-18

### Changed

- import `windows-curses` to allow using the selection screens on windows

## [2026.8.2] - 2026-08-18

### Fixed

- the release workflows were referring to incorrect prior step due to being copied from `sd-lock-util`
...
[Unreleased]: https://gitlab.ci.csc.fi/sds-dev/sd-connect/sd-connect-s3-migrate/compare/2026.9.4...HEAD
[2026.9.4]: https://gitlab.ci.csc.fi/sds-dev/sd-connect/sd-connect-s3-migrate/compare/2026.9.3...2026.9.4
...
[2026.8.2]: https://gitlab.ci.csc.fi/sds-dev/sd-connect/sd-connect-s3-migrate/compare/2026.8.1...2026.8.2
[2026.8.1]: https://gitlab.ci.csc.fi/sds-dev/sd-connect/sd-connect-s3-migrate/compare/2026.8.0...2026.8.1
